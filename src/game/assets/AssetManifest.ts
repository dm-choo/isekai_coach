...
export const CHARACTER_VISUALS: Record<string, CharacterVisualConfig> = {
  administrator_submission_01: {
    ...
    displayName: '관리자',
    displaySize: { width: 90, height: 135 },
  ...
  goblin_warrior_submission_01: {
    ...
    displayName: '고블린 전사',
    displaySize: { width: 112, height: 126 },
  ...
  goblin_bomber_submission_01: {
    ...
    displayName: '고블린 투척병',
    displaySize: { width: 106, height: 128 },
  ...
  goblin_archer_slice_02: {
    spriteKey: 'goblin_archer_slice_02',
    source: { type: 'IMAGE', url: 'assets/slice2/goblin-archer-v1.png' },
    displayName: '고블린 궁수',
    displaySize: { width: 138, height: 180 },
    footAnchor: { x: 0.48, y: 0.985 },
    nativeFacing: 'LEFT',
    silhouette: 'ARCHER',
    palette: { body: 0x4f5d2d, accent: 0xc08b48, shadow: 0x111508 },
    animations: animationSet('goblin_archer_slice_02'),
  },
  goblin_warrior_slice_02: {
    spriteKey: 'goblin_warrior_slice_02',
    source: { type: 'IMAGE', url: 'assets/slice2/goblin-warrior-v1.png' },
    displayName: '고블린 전사',
    displaySize: { width: 151, height: 180 },
    footAnchor: { x: 0.5, y: 0.94 },
    nativeFacing: 'LEFT',
    silhouette: 'RAIDER',
    palette: { body: 0x59672f, accent: 0xb24c39, shadow: 0x131708 },
    animations: animationSet('goblin_warrior_slice_02'),
  },
  goblin_bomber_slice_02: {
    spriteKey: 'goblin_bomber_slice_02',
    source: { type: 'IMAGE', url: 'assets/slice2/goblin-bomber-v1.png' },
    displayName: '고블린 투척병',
    displaySize: { width: 139, height: 180 },
    footAnchor: { x: 0.51, y: 0.965 },
    nativeFacing: 'LEFT',
    silhouette: 'RAIDER',
    palette: { body: 0x55612e, accent: 0xd09b44, shadow: 0x141608 },
    animations: animationSet('goblin_bomber_slice_02'),
  },
  operator_slice_01: {

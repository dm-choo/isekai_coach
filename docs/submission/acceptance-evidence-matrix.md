...
| 주인공 활성화 뒤 contour·샘·다음 좌표 변화 | world unit + P4 golden의 두 owned tile·6-edge outer contour·active anchor/spring +1·세 linked OUTSIDE tile, text-off·양 비율 캡처 | A+V, 인과 설명은 H REQUIRED |

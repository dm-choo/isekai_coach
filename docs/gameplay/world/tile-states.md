...
- **흐림**: 회색 실루엣. 주변 클리어, 비콘, 횃불 또는 과거 클리어 후 재침식으로 생긴다.
...
표현 단계와 별도로 최소 `discovered`, `cleared`, `currentlySecure`, `stabilized`, `facility`, `occupyingParty`를 구분한다.

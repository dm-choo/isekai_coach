...
15. 실제 누적 HP가 낮으면 안전한 중앙 방에서 물·식량·20분을 쓰는 휴식과 SCOUTED 유지
16. 선택 정책→400m 경로·두 위협→중단 조건→비합산 병렬 시간의 위임 계획
17. 실제 12×3 위임 기록→피해·시간→TIME_LIMIT/SECURED 경로 결과와 다음 행동
18. 동료 확보 경로→주인공 400m 이동→도착 후에도 OUTSIDE인 비활성 거점 연결
19. 16:9·4:3 layout과 console/page/request errors 0건
20. 기존 Slice 1·2 회귀
